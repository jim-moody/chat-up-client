...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _events3 = __webpack_require__(34);
	...
	var setAPIOrigin = __webpack_require__(62);
	...
	var setUser = function setUser() {
	  ...
	  if (user && user !== 'undefined') {
	    _store2.default.user = JSON.parse(user);
	    _ui2.default.toggleMenuLinks(true);
	    $('#show-submit-line').show();
	  }
	  // then start the app
	  (0, _helpers.showLoader)();
	  _events2.default.onListLines();
	};

	$(function () {
	  setAPIOrigin(location, config);
	  _events4.default.addEventHandlers();
	  _events2.default.addEventHandlers();
	  setUser();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lineEdit = __webpack_require__(33);

	var _lineEdit2 = _interopRequireDefault(_lineEdit);
	...
	var onSubmitLine = function onSubmitLine(e) {
	  // prevent page from refreshing
	  e.preventDefault();

	  // get the text from the form
	  var text = $('#line-textarea').val();
	  ...
	  if (text) {
	    ...
	    var userId = _store2.default.user.id;
	    var data = {
	      line: {
	        text: text,
	        user_id: userId
	    ...
	    var successCallback = function successCallback(data) {
	      _ui2.default.submitLineSuccess(data);
	    ...
	    (0, _helpers.showLoader)();
	    _api2.default.submitLine(data).then(successCallback).catch(_ui2.default.submitLineFailure);
	  } else {
	    ...
	    var _text = 'Please enter text before submitting';
	    (0, _helpers.showAlert)(parent, _text, 'error');
	  }
	};

	var onListLines = function onListLines() {
	  ...
	  var successCallback = function successCallback(data) {
	    _ui2.default.listLinesSuccess(data);
	  ...
	  _api2.default.listLines().then(successCallback).catch(_ui2.default.listLinesFailure);
	};

	var onDeleteLine = function onDeleteLine(e) {
	  // hide the delete
	  var container = $(e.target).closest('.form-card');
	  container.fadeOut('slow', function () {
	    // get the id from the delete button
	    var id = $(e.target).data('id');

	    var failHandler = function failHandler(data) {
	      container.fadeIn();
	      _ui2.default.deleteLineFailure(data);
	    };
	    (0, _helpers.showLoader)();
	    // call the api with the id, then re-render the list of lines
	    _api2.default.deleteLine(id).then(onListLines).catch(failHandler);
	  });
	};
	var onShowEditLine = function onShowEditLine(e) {
	  ...
	  var lineParent = target.closest('.line-parent');
	  var lineDisplayContainer = lineParent.find('.display-line-container');
	  var lineContainer = lineParent.find('.line-text-container');

	  // get the text from the container and trim it so we dont have trailing
	  // whitespace
	  var text = lineContainer.find('.line-text').text().trim();

	  // show the edit template with text from parent
	  // build the handlebar template for editing with the text
	  var html = (0, _lineEdit2.default)({ id: id });
	  ...
	  lineDisplayContainer.fadeOut('slow', function () {
	    ...
	    (0, _helpers.textAreaAutoResize)();
	    $('textarea').on('keyup keydown', function () {
	      (0, _helpers.textAreaAutoResize)();
	    });
	  });
	};
	var onCancelEditLine = function onCancelEditLine(e) {
	  var lineContainer = $(e.target).closest('.line-parent').find('.display-line-container');
	...
	var onShowEditOptions = function onShowEditOptions(e) {
	...
	var onUpdateLine = function onUpdateLine(e) {
	  // get the current line id and new text
	  var id = $(e.target).data('id');
	  var text = $('#line-textarea-edit').val();
	  ...
	  // make the call to the API
	  (0, _helpers.showLoader)();
	  _api2.default.updateLine(data).then(_ui2.default.updateLineSuccess).catch(_ui2.default.updateLineFailure);
	};
	var onShowSubmitLine = function onShowSubmitLine(e) {
	  // show the add line textarea
	  $('#submit-line-container').slideDown(function () {
	...
	var onCancelSubmitLine = function onCancelSubmitLine(e) {
	  // hide the add line textarea
	  (0, _helpers.resetForm)($('#submit-line-container')).slideUp();
	...
	var onAddVote = function onAddVote(e) {
	  ...
	  if (_store2.default.user) {
	    ...
	    var target = $(e.target);
	    var tabGender = target.closest('.tab-content').data('gender');
	    var userGender = _store2.default.user.gender;
	    ...
	    if (tabGender && tabGender !== userGender) {
	      ...
	      var parent = target.closest('.voting-container'); // $(`.line-parent[data-id="${lineId}"]`)

	      // update the total points
	      var totalPointsElement = parent.find('.total.vote-container');
	      var currentPoints = parseInt(totalPointsElement.text());
	      var upVote = parent.find('.up-vote');
	      var downVote = parent.find('.down-vote');
	      var newUpVoteClass = '';
	      var newDownVoteClass = '';
	      ...
	      var failHandler = function failHandler() {
	        onListLines();
	        _ui2.default.addVoteFailure;
	      };

	      _api2.default.addVote(data).then(_ui2.default.addVoteSuccess).catch(failHandler);
	    }
	  } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var submitLine = function submitLine(data) {
	  return $.ajax({
	...
	var listLines = function listLines() {
	  var token = _store2.default.user && _store2.default.user.token || '';
	  return $.ajax({
	    url: config.apiOrigin + '/lines',
	    method: 'GET',
	    headers: {
	...
	var deleteLine = function deleteLine(id) {
	  return $.ajax({
	...
	var updateLine = function updateLine(_ref) {
	  var id = _ref.id,
	      data = _ref.data;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _linesList = __webpack_require__(30);

	var _linesList2 = _interopRequireDefault(_linesList);

	var _helpers2 = __webpack_require__(32);
	...
	var submitLineSuccess = function submitLineSuccess(_ref) {
	  var line = _ref.line;
	  ...
	  (0, _helpers.hideLoader)();
	  // reset the form so another line can be added
	  (0, _helpers.resetForm)($('#submit-line-container')).slideUp();
	};

	var submitLineFailure = function submitLineFailure(data) {
	  (0, _helpers.hideLoader)();
	  Materialize.toast('There was an issue adding your message', 3000);
	};

	var listLinesSuccess = function listLinesSuccess(_ref2) {
	  var lines = _ref2.lines;

	  var target = $('.tab a.active').attr('href');
	  $('.tab-content').empty();
	...
	var listLinesFailure = function listLinesFailure(data) {
	  (0, _helpers.hideLoader)();
	  Materialize.toast('Something went wrong', 3000);
	};

	var deleteLineSuccess = function deleteLineSuccess(callback) {
	  (0, _helpers.hideLoader)();
	  callback();
	};

	var deleteLineFailure = function deleteLineFailure(data) {
	  (0, _helpers.hideLoader)();
	  Materialize.toast('There was an issue deleting your message', 3000);
	};

	var updateLineSuccess = function updateLineSuccess(_ref3) {
	  var line = _ref3.line;

	  (0, _helpers.hideLoader)();
	  var lineParent = $('div[data-id=' + line.id + ']');
	  var lineDisplay = lineParent.find('.display-line-container');
	  var lineContainer = lineParent.find('.line-text-container');
	...
	var updateLineFailure = function updateLineFailure(data) {
	  (0, _helpers.hideLoader)();
	...
	var addVoteFailure = function addVoteFailure(data) {

	  Materialize.toast('There was an issue adding your vote', 3000);
	};

	var renderList = function renderList(anchor, lines) {
	  // add a summary to each line
	  lines.forEach(function (line) {
	    line.text = line.text.trim();
	    line.voteSummary = (0, _helpers2.getVoteSummary)(line.votes);
	    ...
	    if (_store2.default.user) {
	      ...
	      // set the value to = 0
	      var _ref4 = line.votes.find(function (vote) {
	        return vote.user_id === _store2.default.user.id;
	      }) || {},
	  ...
	  var html = (0, _linesList2.default)({ lines: lines });
	...
	var voteActionClass = function voteActionClass(value, action) {
	  var highlightClass = '';
	...
	var renderMostPopularList = function renderMostPopularList(linesList) {
	  // get the list html element
	  var list = $('#lines-list-most-popular');

	  // order the lines by total points
	  var popularList = linesList.sort(sortMostPopular);

	  // render the list
	  renderList(list, popularList);
	};
	var renderMaleFavoriteList = function renderMaleFavoriteList(linesList) {
	  var list = $('#lines-list-male-favorite');

	  // create a new list so that we dont alter it for other renderings
	  var maleList = linesList.map(function (line) {
	    return JSON.parse(JSON.stringify(line));
	  });

	  // get only the male votes
	  maleList = maleList.map(function (line) {
	    line.votes = line.votes.filter(function (vote) {
	      return vote.gender === 'm';
	    });
	    return line;
	  });
	...
	var renderFemaleFavoriteList = function renderFemaleFavoriteList(linesList) {
	  var list = $('#lines-list-female-favorite');

	  // create a new list so we dont alter it for other renderings
	  var femaleList = linesList.map(function (line) {
	    return JSON.parse(JSON.stringify(line));
	  });

	  // get only the female votes
	  femaleList = femaleList.map(function (line) {
	    line.votes = line.votes.filter(function (vote) {
	      return vote.gender === 'f';
	    });
	    return line;
	  });
	...
	var renderNewestList = function renderNewestList(linesList) {
	  // get the list html element
	  var list = $('#lines-list-newest');

	  // order the lines by id, oldest to newest
	  var newestList = linesList;
	  newestList.sort(function (line1, line2) {
	...
	var sortMostPopular = function sortMostPopular(line1, line2) {
	  var sum = (0, _helpers2.totalPoints)(line2) - (0, _helpers2.totalPoints)(line1);
	  if (sum === 0) {
	...
	module.exports = {
	  submitLineSuccess: submitLineSuccess,
	  submitLineFailure: submitLineFailure,
	  listLinesSuccess: listLinesSuccess,
	  listLinesFailure: listLinesFailure,
	  deleteLineSuccess: deleteLineSuccess,
	  deleteLineFailure: deleteLineFailure,
	  updateLineSuccess: updateLineSuccess,
	  updateLineFailure: updateLineFailure,
	  addVoteFailure: addVoteFailure,
	  voteActionClass: voteActionClass,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _alertError = __webpack_require__(9);

	var _alertError2 = _interopRequireDefault(_alertError);
	...
	var resetForm = function resetForm($form) {
	  var elements = $form.find('input, textarea, label');
	...
	var showAlert = function showAlert(parent, text, type) {
	  // clear any existing alerts
	  $('.alert-anchor').empty();

	  // set the correct template
	  var template = type === 'error' ? _alertError2.default : _alertError2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"red-text text-darken-4\" style=\"padding: 5px 0 10px 0;\">\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"loader\" style=\"\nopacity: 0.8;\n  background-color: #fff;\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  top: 0px;\n  left: 0px;\n  z-index: 100;\n\">\n    <div class=\"preloader-wrapper big active\" style=\"/* height: 50%; */ /* Set your own height: percents, ems, whatever! *//* width: 50%; */ /* Set your own width: percents, ems, whatever! */overflow: auto; /* Recommended in case content is larger than the container */margin: auto; /* Center the item vertically &amp; horizontally */position: absolute; /* Break it out of the regular flow */top: 0;left: 0;bottom: 0;right: 0;/* background-color: white; */\">\n    <div class=\"spinner-layer spinner-blue-only\">\n      <div class=\"circle-clipper left\">\n        <div class=\"circle\"></div>\n      </div><div class=\"gap-patch\">\n        <div class=\"circle\"></div>\n      </div><div class=\"circle-clipper right\">\n        <div class=\"circle\"></div>\n      </div>\n    </div></div>\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(31),depth0,{"name":"line","hash":{"line":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.lines : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.text : stack1), depth0));
	},"3":function(container,depth0,helpers,partials,data) {
	    return "No description.";
	},"5":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return " <div class=\"edit-link-container\"><i class=\"blue-text text-darken-3 edit-options fa fa-ellipsis-v fa-lg\" aria-hidden=\"true\"></i>\n   <!-- Dropdown Structure -->\n   <ul  style=\"display:none;\" class='blue-text text-darken-3 card edit-dropdown-content'>\n     <li class=\"edit\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n       <i class=\"material-icons\">edit</i>\n       Edit\n     </li>\n     <li class=\"delete\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n       <i class=\"material-icons\">delete</i>\n       Delete\n     </li>\n   </ul>\n </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : {};

	  return "<div class=\"form-card line-parent\"  data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div style=\"display:flex;\" class=\"display-line-container\">\n\n  <div id=\"votes-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"voting-container\">\n    <div class=\"vote-container\">\n      <i data-action=\"up\" data-value=\"1\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\"class=\"blue-text text-darken-3 vote up-vote material-icons "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.userUpVotedClass : stack1), depth0))
	    + "\">arrow_drop_up</i>\n    </div>\n      <div data-id=\"total-points-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"total vote-container\">"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.voteSummary : stack1)) != null ? stack1.total : stack1), depth0))
	    + "</div>\n    <div class=\"vote-container\">\n      <i data-action=\"down\" data-value=\"-1\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"blue-text text-darken-3 vote down-vote material-icons "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.userDownVotedClass : stack1), depth0))
	    + "\">arrow_drop_down</i>\n    </div>\n  </div>\n<div style=\"flex: 1;\" class=\"line-text-container\">\n  <div class=\"line-text\">\n    <p>"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.text : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "</p>\n  </div>\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.line : depth0)) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</div>\n\n</div>\n\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports) {
	...
	var getVoteSummary = function getVoteSummary(votes) {
	  var voteSummary = {
	    up: 0,
	    down: 0,
	    total: 0
	...
	var totalPoints = function totalPoints(line) {
	  var _getVoteSummary = getVoteSummary(line.votes),
	      up = _getVoteSummary.up,
	      down = _getVoteSummary.down;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div style=\"display:none;\" class=\"input-field edit-container\">\n  <textarea class=\"materialize-textarea\" rows=\"1\" id=\"line-textarea-edit\"></textarea>\n<div class=\"edit-button-container\">\n\n  <button class=\"btn blue darken-3\" id=\"line-edit-cancel\" type=\"button\" name=\"button\">Cancel</button>\n  <button class=\"btn blue darken-3\" data-id=\""
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" id=\"line-edit-save\" type=\"button\">Save</button>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onScroll = function onScroll() {
	  ...
	  var navContentOffset = $('.nav-content').offset().top - $(window).scrollTop();
	...
	var onTabClick = function onTabClick() {
	  (0, _events3.onListLines)();
	};

	// add event handlers
	var addEventHandlers = function addEventHandlers() {
	  $('#nav-sign-in-link').on('click', _events2.default.onShowSignIn);
	  $('#nav-sign-up-link').on('click', _events2.default.onShowSignUp);
	  $('#nav-sign-out-link').on('click', _events2.default.onSignOut);
	  $('#nav-change-password-link').on('click', _events2.default.onShowChangePassword);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getFormFields = __webpack_require__(39);
	...
	var _changePassword = __webpack_require__(43);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  var tempData = (0, _getFormFields2.default)(event.target);
	  var credentials = tempData.credentials;
	  ...
	  var _data$credentials = data.credentials,
	      email = _data$credentials.email,
	      password = _data$credentials.password,
	      passwordConfirmation = _data$credentials.password_confirmation,
	      gender = _data$credentials.gender;
	  ...
	  if (email && password && passwordConfirmation && gender) {
	    ...
	    _api2.default.signUp(data).then(_ui2.default.signUpSuccess).catch(_ui2.default.signUpFailure);
	  } else {
	    // let the user know that they need to fill out the form, because they must
	    // have missed a field
	    var form = $(event.target);
	    var errorText = 'Please fill in all fields';
	    (0, _helpers.showAlert)(form, errorText, 'error');
	  }
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  var data = (0, _getFormFields2.default)(event.target);
	  ...
	  if (data.credentials.email && data.credentials.password) {
	    ...
	    // send the data to the backend and handle success/fail
	    _api2.default.signIn(data).then(_ui2.default.signInSuccess).catch(_ui2.default.signInFailure);
	  } else {
	...
	var onShowSignUp = function onShowSignUp(e) {
	  ...
	  if (!$('#sign-up-container').is('visible')) {
	    ...
	    $('#auth-content').empty().append(_signUp2.default);
	...
	var onSignOut = function onSignOut() {
	  ...
	  _api2.default.signOut(_store2.default.user).then(_ui2.default.signOutSuccess).catch(_ui2.default.signOutFailure);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  var _data$passwords = data.passwords,
	      old = _data$passwords.old,
	      newPassword = _data$passwords.new;
	  ...
	  if (old && newPassword) {
	    ...
	    _api2.default.changePassword(data).then(_ui2.default.changePasswordSuccess).catch(_ui2.default.changePasswordFailure);
	  } else {
	...
	var onShowSignIn = function onShowSignIn(e) {
	  ...
	  if (!$('#sign-in-container').is('visible')) {
	    ...
	    $('#auth-content').empty().append(_signIn2.default);
	...
	var onCloseAuthForm = function onCloseAuthForm(event) {
	  $('#auth-content').empty();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(data) {
	  ...
	  _api2.default.signIn({ credentials: credentials }).then(signInSuccess).catch(signInFailure);

	  // clear/reset the sign in form in case the user gets back there somehow
	  // and then hide it
	  (0, _helpers.resetForm)($('#sign-up-container')).hide();
	};
	...
	var signUpFailure = function signUpFailure(data) {
	  ...
	  var parent = $('#sign-up');
	  var text = 'There was an issue creating your account';
	  (0, _helpers.showAlert)(parent, text, 'error');
	};

	var signInSuccess = function signInSuccess(_ref) {
	  var user = _ref.user;
	  ...
	  (0, _ui.toggleMenuLinks)(true);

	  // clear/reset the sign in form in case the user gets back there somehow
	  (0, _helpers.resetForm)($('#sign-in-container')).hide();
	  $('.alert-anchor').empty();
	...
	var signInFailure = function signInFailure(data) {
	  ...
	  var parent = $('#sign-in');
	  var text = 'There was an issue signing you in';
	  (0, _helpers.showAlert)(parent, text, 'error');
	};
	...
	var signOutSuccess = function signOutSuccess(data) {
	  ...
	  (0, _ui.toggleMenuLinks)();

	  // hide change pw just in case it was shown
	  (0, _helpers.resetForm)($('#change-pw-container'));
	  $('#auth-content').empty();
	  ...
	  (0, _helpers.resetForm)($('#submit-line-container')).hide();
	  $('#show-submit-line').hide();

	  // clear the user info from memory so a new user can log in
	  _store2.default.user = undefined;
	...
	var changePasswordSuccess = function changePasswordSuccess(data) {
	  ...
	  (0, _helpers.resetForm)($('#change-pw-container')).hide();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var changePassword = function changePassword(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/change-password/' + _store2.default.user.id,
	    method: 'PATCH',
	    headers: {
	      Authorization: 'Token token=' + _store2.default.user.token
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toggleMenuLinks = function toggleMenuLinks(isLoggedIn) {
	  if (isLoggedIn) {
	    $('a.signed-in').show();
	    $('a.signed-out').hide();
	  } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addNestedValue = __webpack_require__(40);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "\n        <!-- SIGN UP -->\n\n        <div id=\"sign-up-container\" class=\"form-card card\">\n          <div>\n            <h4 class=\"blue darken-2 form-title\">Sign Up\n                <i id=\"close-form\" style=\"float:right; cursor: pointer;\" class=\"material-icons\">close</i>\n              </h4>\n          </div>\n          <form id=\"sign-up\">\n            <fieldset style=\"display:flex;\">\n              <div class=\"input-field\">\n                <input  type=\"text\" class=\"validate\" name=\"credentials[email]\" id=\"sign-up-email\">\n                <label for=\"sign-up-email\">Email</label>\n              </div>\n\n              <div class=\"input-field\">\n                <input  type=\"password\" class=\"validate\" name=\"credentials[password]\" id=\"sign-up-password\">\n                <label for=\"sign-up-password\">Password</label>\n              </div>\n              <div class=\"input-field\">\n                <input  type=\"password\" class=\"validate\"  name=\"credentials[password_confirmation]\" id=\"sign-up-password-confirmation\">\n                <label for=\"sign-up-password-confirmation\">Confirm Password</label>\n              </div>\n              <div class=\"radio-group\" id=\"sign-up-gender\">\n                <p style=\"float:left; margin-right: 10px;\">\n                  <input name=\"gender\" type=\"radio\" id=\"gender-male\" />\n                <label for=\"gender-male\">Male</label>\n              </p>\n              <p>\n                <input name=\"gender\" type=\"radio\" id=\"gender-female\" />\n                <label for=\"gender-female\">Female</label>\n              </p>\n            </div>\n              <div class=\"alert-anchor\"></div>\n<button type=\"submit\" name=\"submit\" class=\"blue darken-3 btn form-button\">          Sign Up\n        </button>\n              <!-- SIGN UP LOADER-->\n              <div id=\"sign-up-loader\" style=\"margin: 0 auto; display:none;\" class=\"mdl-spinner mdl-spinner--single-color mdl-js-spinner is-active\"></div>\n            </fieldset>\n          </form>\n        </div>\n        <!-- SIGN UP ALERTS -->\n        <div style=\"display: none;\" id=\"sign-up-empty-alert\" class=\"auth-form-alert alert alert-danger\" role=\"alert\">Please fill in all the fields</div>\n        <div style=\"display: none;\" id=\"sign-up-failure-alert\" class=\"auth-form-alert alert alert-danger\" role=\"alert\">Sorry, there was an issue creating your account. Please try again later.</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- SIGN IN -->\n<div id=\"sign-in-container\" class=\"form-card card\">\n  <div >\n\n    <h4 class=\"blue darken-2 form-title\">Log In\n    <i id=\"close-form\" style=\"float:right; cursor: pointer;\" class=\"material-icons\">close</i>\n  </h4>\n  </div>\n\n  <form id=\"sign-in\">\n    <fieldset style=\"display:flex;\">\n      <div class=\"input-field\">\n        <input type=\"text\" class=\"validate\" name=\"credentials[email]\" id=\"sign-in-email\">\n        <label for=\"sign-in-email\">Email</label>\n      </div>\n      <div class=\"input-field\">\n        <input  type=\"password\" class=\"validate\" name=\"credentials[password]\" id=\"sign-in-password\">\n        <label for=\"sign-in-password\">Password</label>\n      </div>\n      <div class=\"alert-anchor\"></div>\n      <button type=\"submit\" name=\"submit\" class=\"blue darken-3 btn form-button\">\n    Sign In\n  </button>\n      <!-- SIGN IN LOADER-->\n      <div id=\"sign-in-loader\" style=\"margin: 0 auto; display:none;\"></div>\n\n    </fieldset>\n  </form>\n</div>\n<!-- SIGN IN ALERTS-->\n<div style=\"display: none;\" id=\"sign-up-success-alert\" class=\"auth-form-alert alert alert-success\" role=\"alert\">You successfully created an account!</div>\n<div style=\"display: none;\" id=\"sign-out-success-alert\" class=\"auth-form-alert alert alert-success\" role=\"alert\">You successfully signed out</div>\n<div style=\"display: none;\" id=\"sign-in-empty-alert\" class=\"auth-form-alert alert alert-danger\" role=\"alert\">Please enter a username and password</div>\n<div style=\"display: none;\" id=\"sign-in-failure-alert\" class=\"auth-form-alert alert alert-danger\" role=\"alert\">There was an issue signing in. Please check your password and try again.</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- CHANGE PASSWORD -->\n\n<div id=\"change-pw-container\" class=\"form-card card\">\n  <div>\n    <h4 class=\"blue darken-2 form-title\">Change Password\n        <i id=\"close-form\" style=\"float:right; cursor: pointer;\" class=\"material-icons\">close</i>\n      </h4>\n  </div>\n  <form id=\"change-pw\">\n    <fieldset style=\"display:flex;\">\n      <div class=\"input-field\">\n        <input type=\"password\" class=\"validate\" name=\"passwords[old]\" id=\"change-pw-password\">\n        <label for=\"change-pw-old-password\">Old Password</label>\n      </div>\n      <div class=\"input-field\">\n        <input type=\"password\" class=\"validate\" name=\"passwords[new]\" id=\"change-pw-password-confirmation\">\n        <label for=\"change-pw-new-password\">New Password</label>\n      </div>\n      <div class=\"alert-anchor\"></div>\n\n      <button type=\"submit\" name=\"submit\" class=\"blue darken-3 btn form-button\">          Change Password\n        </button>\n      <!-- CHANGE PASSWORD LOADER-->\n      <div id=\"sign-up-loader\" style=\"margin: 0 auto; display:none;\" class=\"mdl-spinner mdl-spinner--single-color mdl-js-spinner is-active\"></div>\n    </fieldset>\n  </form>\n</div>\n<!-- CHANGE PASSWORD ALERTS -->\n<!-- <div style=\"display: none;\" id=\"sign-up-empty-alert\" class=\"auth-form-alert alert alert-danger\" role=\"alert\">Please fill in all the fields</div>\n        <div style=\"display: none;\" id=\"sign-up-failure-alert\" class=\"auth-form-alert alert alert-danger\" role=\"alert\">Sorry, there was an issue creating your account. Please try again later.</div> -->\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59), __webpack_require__(59), __webpack_require__(59)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var parseNestedQuery = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Lora);", ""]);

	// module
	exports.push([module.id, "html {\n  font-size: 14px; }\n\nmain {\n  padding: 10px; }\n\nbody {\n  background-color: #f5f4f4;\n  font-family: Roboto; }\n\n.main-header {\n  margin-left: 0; }\n\ninput[type=\"text\"], input[type=\"number\"], textarea {\n  font-size: 16px !important; }\n\na:hover {\n  text-decoration: none; }\n\n.auth-form-alert {\n  margin: 3% auto;\n  max-width: 330px; }\n\ndiv.radio-group {\n  border-bottom: 1px solid #dedede;\n  padding: 10px 0 20px 0;\n  margin-bottom: 20px; }\n  div.radio-group p:nth-child(1) {\n    float: left;\n    margin-right: 10px; }\n  div.radio-group p.label {\n    line-height: 25px;\n    color: #9e9e9e; }\n\n[type=\"radio\"]:not(:checked) + label, [type=\"radio\"]:checked + label {\n  padding-left: 25px; }\n\n.form-subtext {\n  text-align: center;\n  padding: 10px;\n  font-size: 1.1em; }\n\n.form-options-container {\n  align-items: center;\n  display: flex;\n  flex-grow: 1;\n  justify-content: center; }\n  .form-options-container button {\n    width: 80%; }\n\n.form-card {\n  margin: 3% auto 0;\n  max-width: 500px; }\n  .form-card p {\n    font-size: 1em;\n    margin: 0 auto; }\n  @media only screen and (max-width: 330px) {\n    .form-card {\n      width: 100%; } }\n  .form-card fieldset {\n    border: 0;\n    padding: 0; }\n\n.form-link {\n  color: #448aff;\n  cursor: pointer; }\n  .form-link:focus, .form-link:hover {\n    color: #23527c; }\n\n.form-title {\n  background-color: #880e4f;\n  color: #fff;\n  text-align: center;\n  padding: 0.5em; }\n\n.form-link {\n  margin-left: 5px; }\n\nmain form {\n  min-height: 200px;\n  padding: 10px;\n  max-width: 400px;\n  margin: 0 auto; }\n\nbutton.form-button {\n  margin: 0 auto;\n  max-width: 300px;\n  min-width: 50%; }\n\nh1 {\n  display: inline-block;\n  margin-left: 10%;\n  margin-right: auto; }\n\n.input-field input:focus:not([readonly]) {\n  border-bottom: 1px solid #1976D2;\n  box-shadow: 0 1px 0 0 #1976D2; }\n\n.input-field input:focus:not([readonly]) + label {\n  color: #1976D2; }\n\n.input-field textarea:focus:not([readonly]) {\n  border-bottom: 1px solid #1976D2;\n  box-shadow: 0 1px 0 0 #1976D2; }\n\n.input-field textarea:focus:not([readonly]) + label {\n  color: #1976D2; }\n\n[type=\"radio\"]:checked + label:after, [type=\"radio\"].with-gap:checked + label:before, [type=\"radio\"].with-gap:checked + label:after {\n  border: 2px solid #1976D2; }\n\n[type=\"radio\"]:checked + label:after, [type=\"radio\"].with-gap:checked + label:after {\n  background-color: #1976D2; }\n\n@media (max-width: 1200px) {\n  header form {\n    clear: both; } }\n\n.edit-link-container {\n  align-self: center;\n  margin: 1.2em; }\n  .edit-link-container i {\n    padding: 5px; }\n    .edit-link-container i:hover {\n      cursor: pointer; }\n\n.create-line-button-container button {\n  margin: 10px; }\n\n.line-parent {\n  margin: 0 auto;\n  background-color: white;\n  border-bottom: 1px solid #dedede;\n  position: relative; }\n  .line-parent:nth-child(1) {\n    margin-top: 1em; }\n\n.line-text-container {\n  font-size: 1.2em;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  text-align: center; }\n\n.line-text {\n  flex-grow: 1;\n  padding: 1.2em; }\n\n.line-parent p, .line-parent textarea {\n  font-family: Lora, serif;\n  color: #464646; }\n\n.line-parent p {\n  white-space: pre-line;\n  text-align: left; }\n\n.input-field textarea {\n  font-size: 1.2em; }\n\n.edit-dropdown-content {\n  background-color: #fff;\n  position: absolute;\n  right: 0;\n  top: 5px;\n  z-index: 2; }\n  .edit-dropdown-content li {\n    padding: 10px 25px;\n    display: flex;\n    justify-content: space-around;\n    align-items: center; }\n    .edit-dropdown-content li:hover {\n      background-color: #2196f3;\n      cursor: pointer; }\n    .edit-dropdown-content li:nth-child(1) {\n      border-bottom: 1px solid #dedede; }\n\n.edit-container {\n  display: flex;\n  flex-direction: column;\n  padding: 1em;\n  width: 100%; }\n  .edit-container textarea {\n    font-size: 1.2em; }\n  .edit-container.input-field {\n    margin-top: 0; }\n\n.edit-button-container {\n  padding: 10px;\n  align-self: flex-end; }\n\n.voting-container {\n  display: flex;\n  justify-content: space-around;\n  font-size: 1.2em;\n  flex-direction: column; }\n  .voting-container .total {\n    font-size: 1.5em; }\n\n.vote-container {\n  align-items: center;\n  display: flex;\n  align-self: center; }\n  .vote-container i {\n    padding: 5px;\n    font-size: 2em;\n    cursor: pointer; }\n\ndiv.nav-content.fixed {\n  position: fixed; }\n\n.navbar-fixed {\n  height: 125px; }\n\n.floating-button.btn-floating.halfway-fab {\n  bottom: 10%;\n  right: 5%; }\n\nnav .brand-logo.left {\n  margin-left: 1.5rem; }\n\n.user-dropdown-content {\n  display: none;\n  position: absolute;\n  top: 45px;\n  right: 10px;\n  margin-top: 0;\n  z-index: 2; }\n  .user-dropdown-content li {\n    color: gray;\n    text-align: center;\n    float: none;\n    padding: 0 1.1em; }\n    .user-dropdown-content li:hover {\n      background-color: #e6e6e6;\n      cursor: pointer; }\n\n.tabs {\n  display: flex;\n  max-width: 1000px; }\n  .tabs .tab {\n    flex-grow: 1; }\n\n@media only screen and (min-width: 600px) {\n  nav .brand-logo.left {\n    margin-left: 0;\n    left: 50%;\n    transform: translateX(-50%); } }\n\n@media only screen and (max-width: 600px) {\n  div.brand-logo.left {\n    font-size: 1.3em; } }\n\nhtml {\n  height: 100%; }\n", ""]);
